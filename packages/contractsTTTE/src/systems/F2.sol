...
import { MapConfig2, Player2,Obstruction2, OwnedBy2, Marker2, Position2, Winner2 } from "../codegen/Tables.sol";
import { MarkerType2 } from "../codegen/Types.sol";
import { addressToEntityKey } from "../addressToEntityKey.sol";
import { positionToEntityKey } from "../positionToEntityKey.sol";

// contract F2System is System {
    enum M {
        x, y, spawn, put, move, reset
    }
    function F2(uint32[] memory input) internal {
