...
// Import user types
import { MonsterCatchResult1 } from "./../Types.sol";

bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("MonsterCatchAtte")));
bytes32 constant MonsterCatchAttempt1TableId = _tableId;

library MonsterCatchAttempt1 {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    return ("MonsterCatchAttempt1", _fieldNames);
  }
  ...
  function emitEphemeral(bytes32 encounter, MonsterCatchResult1 result) internal {
  ...
  function emitEphemeral(IStore _store, bytes32 encounter, MonsterCatchResult1 result) internal {
    bytes memory _data = encode(result);
  ...
  function encode(MonsterCatchResult1 result) internal view returns (bytes memory) {
