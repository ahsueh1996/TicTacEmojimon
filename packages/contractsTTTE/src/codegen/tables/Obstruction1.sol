...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("Obstruction1")));
bytes32 constant Obstruction1TableId = _tableId;

library Obstruction1 {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("Obstruction1", _fieldNames);
  }
